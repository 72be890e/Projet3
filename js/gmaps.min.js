...
"function"==typeof b.getTileUrl)b.tileSize=b.tileSize||new google.maps.Size(256,256),b=new google.maps.ImageMapType(b),this.map.mapTypes.set(a,b);else throw"'getTileUrl' function required.";};k.prototype.addOverlayMapType=function(a){if(a.hasOwnProperty("getTile")&&"function"==typeof a.getTile){var b=a.index;delete a.index;this.map.overlayMapTypes.insertAt(b,a)}else throw"'getTile' function required.";};k.prototype.removeOverlayMapType=function(a){this.map.overlayMapTypes.removeAt(a)};k.prototype.addStyle=
